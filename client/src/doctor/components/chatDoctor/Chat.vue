    ...
    <div id="app">
        <div class="container">
            <vs-col class="col-lg-6 offset-lg-3">
                ...
                <div v-if="!ready">
                    ...
                    <vs-form @submit.prevent="addUser">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="send">
                            <div class="form-group">
                                <vs-input type="text" class="form-control" v-model="newMessage"
                                    placeholder="Enter message here"></vs-input>
                            </div>
                        </form>
                    </div>
                </div>
