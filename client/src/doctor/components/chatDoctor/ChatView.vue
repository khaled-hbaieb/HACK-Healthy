  ...
  <!-- <vs-card class="card m-b-0">
    ...
    <div class="chat-main-box">
      ...
      <div class="chat-left-aside">
        ...
        <div class="chat-left-inner">
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="2">
            <vs-input class="form-control p-2" type="text" placeholder="Search Contact" />
          </vs-col>
          <vs-row
          ...
          >
            <vs-list-item>
              <a href="javascript:void(0)">
                <vs-image alt="user-img" class="img-circle" />
                <span>
                  Varun Dhavan
            ...
            <vs-list-item vs-offset="-30">
              <a href="javascript:void(0)">
                <vs-image alt="user-img" class="img-circle" vs-offset="-30" />
                <span>
                  Ritesh Deshmukh
      ...
      <div class="chat-right-aside">
          ...
          <vs-list class="chat-list p-3">
            ...
            <vs-list-item>
              ...
              >
                ...
                <vs-col class="box bg-light-info">
                  Lorem Ipsum is simply dummy text of the printing & type
                  setting industry.
                </vs-col>
                <vs-col class="chat-time">10:56 am</vs-col>
              </vs-col>
            </vs-list-item>
        ...
        <vs-card class="card-body border-top">
          <vs-row class="row">
            <vs-col class="col-8">
              <vs-textarea
                vs-lg="12px"
            ...
            <vs-col class="col-4 text-right">
              <vs-button type="button" class="btn btn-info btn-circle btn-lg">
                <vs-icon icon size="small"></vs-icon>
              </vs-button>
            </vs-col>
          </vs-row>
        </vs-card>
          ...
          <div class="card-header msg_head">
            ...
            <div class="action_menu">
              <vs-list>
                ...
                <vs-list-item
                  ><i class="fas fa-plus"></i> Add to group</vs-list-item
                >
                <vs-list-item><i class="fas fa-ban"></i> Block</vs-list-item>
              </vs-list>
            </div>
          </div>
          <div class="card-body msg_card_body">
            <div class="d-flex justify-content-start mb-4">
              ...
              <div class="msg_cotainer">
                Hi, how are yousgqgfgfsgsfgfsgsfqsfgsfgfgsvsfgsdgsqggsdqg sgdqsg
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos
                unde perspiciatis eum, praesentium consequuntur ullam impedit
                earum culpa numquam deleniti nisi, quo nihil repudiandae sint
                quod corrupti, assumenda ratione dolorum? ?
