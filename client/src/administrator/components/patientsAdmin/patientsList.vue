      ...
      <vs-col vs-xs="12" vs-sm="6" vs-lg="3">
        <vs-card vs-xs="12" vs-sm="12" vs-lg="12" id="profile" actionable class="cardx">
          ...
          <div id="footer" slot="footer">
            <h3 class="box-title">Ali Essoudani</h3>
            <small>Job: Life Coach</small>
            <br />
            <small>Age: 29 years</small>
          </div>
        </vs-card>
      </vs-col>
      <vs-col vs-xs="12" vs-sm="6" vs-lg="3">
        <vs-card vs-xs="12" vs-sm="12" vs-lg="12" id="profile" actionable class="cardx">
          <div slot="media">
            <a href="/patients/patient">
              <img
                id="patient-profile-image"
                :src="require('@/assets/images/users/charaf.jpg')"
                alt="user"
              />
            </a>
          </div>
          <div id="footer" slot="footer">
            <h3 class="box-title">Charaf Chroudi</h3>
            <small>Job: Developer</small>
            <br />
            <small>Age: 19 years</small>
          </div>
        </vs-card>
      </vs-col>
      <vs-col vs-xs="12" vs-sm="6" vs-lg="3">
        <vs-card vs-xs="12" vs-sm="12" vs-lg="12" id="profile" actionable class="cardx">
          <div slot="media">
            <a href="/patients/patient">
              <img
                id="patient-profile-image"
                :src="require('@/assets/images/users/khaled.jpg')"
                alt="user"
              />
            </a>
          </div>
          <div id="footer" slot="footer">
            <h3 class="box-title">Khaled Hbaieb</h3>
            <small>Job: Jobless</small>
            <br />
            <small>Age: 24 years</small>
          </div>
        </vs-card>
      </vs-col>
    </vs-row>
